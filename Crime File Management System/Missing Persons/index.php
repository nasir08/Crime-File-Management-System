...
<body>
 <center>
  ...
  <td align="center" valign="middle" width="5px">&nbsp;</td>
    ...
    <td align="center" valign="middle" width="5px">&nbsp;</td>
    <td align="center" valign="middle" width="150px" class="menu" id="current"><a href="../Missing Persons">MISSING PERSONS</a></td>
    <td align="center" valign="middle" width="5px">&nbsp;</td>
...
$from=(($page*5)-5);
 $query="SELECT * FROM missing_persons LIMIT $from,5";
 ...
 while($row=mysql_fetch_row($result))
 {
    ...
    $attributes=$row[7];
      echo"
    <tr>
    <td width=255 height=160 rowspan=8 align=left valign=top class=holder scope=col><img src=../uploads/missing-persons/$picture width=255 height=255 /></td>
  ...
  <tr>
    <td height=31 colspan=2 align=center scope=col>If found, please <a href=../contact.php?subject=Missing%20Person%20Found>click here</a> to contact us.</td>
    </tr>
  <tr>
...
echo"<center>";
         ...
         {
           echo"&nbsp;<a href=../CFMS/Missing%20Persons/?page=$i>$i&nbsp;&nbsp;&nbsp;&nbsp;</a>";  
         }
         }
        echo"</center>"; 
    ?>
